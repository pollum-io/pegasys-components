...
const Button = (props) => {
    ...
    return (jsxRuntime.jsx(Root$4, Object.assign({}, rest, { as: as, target: target }, { children: loading ? (loadingText || 'Loading...') : (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [iconBefore && jsxRuntime.jsx(IconBefore, { children: iconBefore }, void 0), children, iconAfter && jsxRuntime.jsx(IconAfter, { children: iconAfter }, void 0)] }, void 0)) }), void 0));
};
Button.defaultProps = {
    target: '_blank',
};
...
const TextInput = (props) => {
    ...
    return (jsxRuntime.jsxs(Box, { children: [jsxRuntime.jsxs(Box, Object.assign({ display: "flex", justifyContent: label ? 'space-between' : 'flex-end' }, { children: [label && jsxRuntime.jsx(Text, Object.assign({ color: "text4" }, { children: label }), void 0), addonLabel && addonLabel] }), void 0), jsxRuntime.jsxs(InputWrapper, { children: [addonBefore && jsxRuntime.jsx(AddonBefore, { children: addonBefore }, void 0), jsxRuntime.jsx(StyledInput, Object.assign({}, rest, { onChange: (e) => {
                        ...
                        } }), void 0), addonAfter && jsxRuntime.jsx(AddonAfter, { children: addonAfter }, void 0)] }, void 0), showErrorMessage && jsxRuntime.jsx(ErrorText, { children: error }, void 0)] }, void 0));
};
...
const Checkbox = (props) => {
    ...
    return (jsxRuntime.jsxs(Root$3, Object.assign({ disabled: disabled, onClick: () => {
...
const CheckboxGroup = (props) => {
    ...
    return (jsxRuntime.jsx(Root$2, Object.assign({ type: type }, { children: (options || []).map((option, i) => (jsxRuntime.jsx(Box, Object.assign({ ml: type === 'horizontal' ? '5px' : '0px' }, { children: jsxRuntime.jsx(Checkbox, Object.assign({ value: option.value, label: option.label, onChange: (chekced, value) => {
...
const RadioButton = (props) => {
    const { value, label, onChange, disabled, size, checked } = props;
    return (jsxRuntime.jsxs(Root$1, Object.assign({ disabled: disabled, onClick: () => {
            onChange && onChange(value);
...
const RadioButtonGroup = (props) => {
    ...
    return (jsxRuntime.jsx(Root, Object.assign({ type: type }, { children: (options || []).map((option, i) => (jsxRuntime.jsx(Box, Object.assign({ ml: type === 'horizontal' ? '5px' : '0px' }, { children: jsxRuntime.jsx(RadioButton, Object.assign({ checked: selected === option.value, value: option.value, label: option.label, onChange: () => {
...
const DoubleCurrencyLogo = ({ currency0, currency1, size = 16, margin = false }) => {
    return (jsxRuntime.jsxs(Wrapper, Object.assign({ sizeraw: size, margin: margin }, { children: [currency0 && jsxRuntime.jsx(HigherLogo, { currency: currency0, size: size.toString() + 'px' }, void 0), currency1 && jsxRuntime.jsx(CoveredLogo, { currency: currency1, size: size.toString() + 'px', sizeraw: size }, void 0)] }), void 0));
};
...
function ThemeProvider({ children, theme }) {
    return jsxRuntime.jsx(Le, Object.assign({ theme: theme || defaultTheme }, { children: children }), void 0);
}
